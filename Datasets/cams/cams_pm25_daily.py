...
cams = xr.open_dataset('/data0/shr/bne/data/raw/pm25/cams/cams_pm25_daymean_2003_2022.nc')
for i in time:
    ...
    cams_df = cams_df.drop('bnds',axis=1).drop('time_bnds',axis=1).rename(columns={'pm2p5':'cams'})
    cams_df['cams'] = cams_df['cams']*(1e9)
    ...
    cams_df.to_csv('/data0/shr/bne/data/pm25/base_models/daily/formatted/cams/cams_pm25_' + i + '_daily.csv',index=False)
