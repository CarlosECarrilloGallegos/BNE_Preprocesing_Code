...
for j in time:
    ...
    for i in csvs:
        ...
        equates = equates[['longitude','latitude','date','O3_MDA8']]
    
        equates_year.append(equates)
    
    equates_final = pd.concat(equates_year)
    
    equates_final = equates_final.rename(columns={'longitude':'lon','latitude':'lat','O3_MDA8':'equates'})
    ...
    equates_final.to_csv('/data0/shr/bne/data/o3/base_models/daily/formatted/equates/equates_o3_' + j + '_daily_mda8.csv', index=False)
