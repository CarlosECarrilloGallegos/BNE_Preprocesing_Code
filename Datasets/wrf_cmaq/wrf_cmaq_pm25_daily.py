...
for i in time:
    filelist = sorted(glob.glob('/data0/shr/bne/data/raw/multi/wrf_cmaq/*' + i + '*pm25*.nc'))
    ...
    wrf.to_csv('/data0/shr/bne/data/pm25/daily/base_models/formatted/wrf_cmaq/wrf_cmaq_pm25_'+i+'_daily.csv',index=False)
